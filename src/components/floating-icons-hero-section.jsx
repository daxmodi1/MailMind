...
// Single icon component with floating and mouse repulsion
const FloatingIcon = ({ mouseX, mouseY, iconData, index }) => {
...
const FloatingIcons = React.forwardRef(({ className, icons, ...props }, ref) => {
